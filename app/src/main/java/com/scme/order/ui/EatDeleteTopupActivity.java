 ...
 * 吃饭年月详情
 */
public class EatDeleteTopupActivity extends BaseActivity {
...
//		actionBar.hide();
		...
		setContentView(R.layout.activity_topupdelete_detailed);
		...
		if(str) {
			new AlertDialog.Builder(this).setTitle("删除提交成功！").setPositiveButton("确定", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					startActivity(new Intent(EatDeleteTopupActivity.this, EatTopupActivity.class));
