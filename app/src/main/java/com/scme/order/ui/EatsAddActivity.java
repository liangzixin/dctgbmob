...
public class EatsAddActivity extends BaseActivity implements View.OnTouchListener {
    ...
    private static final String[] m={"请选择份数","1","2","3","4","5"};
...
//    private Spinner countySpinner = null;    //县级（区、县、县级市
    ...
    @InjectView(R.id.Teats_Time1) MaterialEditText  etStartTime;
    @InjectView(R.id.Teats_operator) MaterialEditText  operator;

  @InjectView(R.id.spin_number)  MaterialSpinner eatnumber;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_eats_detailadd);
...
//                    System.out.println("我的线程："+msg.what);
                    switch (msg.what) {
                        ...
                        case 1:
                            ...
                            etStartTime.setOnTouchListener(EatsAddActivity.this);
    ...
    public void addEat() {
        progressDialog = new ProgressDialog(this);
        progressDialog.setMessage("添加就餐提交中  请稍后...");
        progressDialog.show();
        testHandler.sendEmptyMessage(2);
        Map<String,String> map = new HashMap<String,String >();

        map.put("name",citySpinner.getSelectedItem().toString());
        map.put("eatdate", etStartTime.getText().toString());
        map.put("eatnumber",eatnumber.getSelectedItemPosition()+"");

//                        map.put("branchname", provinceSpinner.getSelectedItemId() + 1 + "");
        map.put("branchname", provinceSpinner.getSelectedItem().toString());
        map.put("operator",user.getName());

        try {
            EatsService eatService = new EatsService();

            str=eatService.addEats(map);
//
        } catch (Exception e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        ...
        if(str) {
            new AlertDialog.Builder(this).setTitle("就餐添加成功！").setPositiveButton("确定", new DialogInterface.OnClickListener() {

                @Override
                public void onClick(DialogInterface dialog, int which) {
                    // TODO Auto-generated method stub

                    startActivity(new Intent(EatsAddActivity.this,EatListActivity.class));

                }
            }).show();
        }else{
            Toast.makeText(this, "就餐添加失败！！！", Toast.LENGTH_SHORT).show();
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_txxxdetail_mainrz) {
            ...
            if ( etStartTime.getText().equals("")){
                Toast.makeText(this, "请选择就餐时间！！！", Toast.LENGTH_SHORT).show();
                return false;
            }

            if (eatnumber.getSelectedItemPosition()==0) {
                Toast.makeText(this, "错误！请选择份数", Toast.LENGTH_SHORT).show();
                return false;
            }
...
//        countySpinner = (Spinner) findViewById(R.id.spin_county);
        ...
        //绑定适配器和值
        provinceAdapter = new ArrayAdapter<String>(EatsAddActivity.this,
...
//
        ...
        cityAdapter = new ArrayAdapter<String>(EatsAddActivity.this,
...
//
                ...
                cityAdapter = new ArrayAdapter<String>(
                        EatsAddActivity.this, android.R.layout.simple_spinner_item,  listuser);
//
                // 设置二级下拉列表的选项内容适配器
