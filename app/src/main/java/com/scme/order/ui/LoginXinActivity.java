...
public class LoginXinActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loginxin);
      ...
      /*
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(LoginXinActivity.this,"我要登录了",Toast.LENGTH_SHORT).show();
            }
        });
        */
    }
